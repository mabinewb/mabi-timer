function get_sailtime(firstsail = "2022-01-13 21:16:31 GMT+0900", mod = 11) {
    let now = new Date();
...
function update_clock(){
    ...
    let now = new Date();
    let sailtime = clocktype.value == "iria" ? get_sailtime() : get_sailtime("2022-01-13 21:16:01 GMT+0900", 6);
